...
public final class ClientSetup {
    ...
    public static void onClientSetup(FMLClientSetupEvent e) {
        ...
        e.enqueueWork(() -> {
            ...
            RSBlocks.JEWEL_GRID.values().forEach(block -> ItemBlockRenderTypes.setRenderLayer(block.get(), RenderType.cutout()));
    ...
    private static void registerBakedModelOverrides() {
        ...
        forEachColorApply("jewel_grid", (name, color) -> BAKED_MODEL_OVERRIDE_REGISTRY.add(name, (base, registry) -> new FullbrightBakedModel(base, true, getColoredModel(color, "block/jewel_grid/cutouts/"))));
